...
class QuestionController extends Controller
{
    ...
    private function _messageForVoiceQuestion($question)
    {
        $questionPhrases = collect(
            [
                'free-answer' => "Please reecord your answer after the beep and then hit the pound sign",
                'yes-no'      => "Please press one for yes and zero for no and then hit the pound sign",
